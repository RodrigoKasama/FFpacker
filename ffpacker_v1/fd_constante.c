...
int write_temp_file(void *dados, tmpinfo_t *temp_arq, int close_flag)
{
	static int fd = 0;
	/* RESOLVER -
	Em caso de interrupção, procurar um arquivo temporário incompleto e completá-lo antes de começar um novo arquivo
	*/
	...
	*/
	...
	// Se nao é para fechar, do contrario fecha, pega o framerate, move.
	if (close_flag)
	{
		// Se fechar o fd primeiro para acessar o fps, na proxima abertura ele incrementa, se fizer o contrário nao...
